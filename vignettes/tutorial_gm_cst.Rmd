---
title: "MORSE tutorial for 'gm' models with constant exposure concentration"
date: "`r Sys.Date()`"
output:
  html_vignette:
    toc: true
...
```{r step3 , eval=FALSE}
fit_cstSD <- survFit(cst_data, model_type = "SD")
```
...
```{r, eval=FALSE}
fit_cstIT <- survFit(cst_data, model_type = "IT")
```
