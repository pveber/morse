...
The following example shows all the stages to pass from a raw bioassay dataset with reproduction data to the estimate values of $EC_x$ and parameters.
The example is based on the `cadmium1` dataset, a reproduction and survival dataset of chronic laboratory bioassays with \emph{Daphnia magna} freshwater invertebrate exposed to five concentrations of one metal contaminant (cadmium) during 21 days.
