...
#' 
#' 
modelData.survDataCstExp <- function(x_survData, model_type = NULL){
  ...
  class(OUT_modelDATA) <- c("modelDataCstExp", "list")
...
#' 
#' 
modelData.survDataVarExp <- function(x_survData,
                                   model_type = NULL,
                                   extend_time = 100){
  ...
  class(OUT_modelDATA) <- c("modelDataVarExp", "list")
