...
#' @param model_type A character specifying TKTD model: \code{SD} or \code{IT}
#' @param quiet If \code{FALSE}, prints logs and progress bar from JAGS.
#' @param nbr.chain The number of parallel chains for the model.
#' @param nbr.adapt The number of iterations for adaptation.
#' @param nbr.iter The number of iterations to monitor
#' @param nbr.warmup The number of iterations in the burnin period.
#' @param nbr.thin The thinning interval for monitors.
#''
#' @return The function returns an object of class \code{survFit}, which is
#' a list with the following fields:
#' \item{mcmc}{an object of class \code{mcmc.list} with the posterior
#' distributions}
#' '\item{mcmc_Null}{an object of class \code{mcmc.list} with the prior
#' distributions}
#' \item{model}{a JAGS model object}
#' \item{mcmcInfo}{a object with information on the MCMC computation:
#' number of chains used, number of iterations, thinning interval}
#' for the MCMC computation}
#' \item{modelData}{a list of data passed to the jags model}
#' \item{model_type}{a character specifying TKTD model: \code{SD} or \code{IT}}
...
survFit.survDataVarC <- function(data,
                                 model_type = NULL,
                                 quiet = FALSE,
                                 nbr.chain = 3,
                                 nbr.adapt = 1000,
